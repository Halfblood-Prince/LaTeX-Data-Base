% Release Notes for LaTeX Application Programming Interface (API) v 6.2.3 %

% Initial release: 03-11-2023 %
% Last Update: 06-11-2023 %
% Library of functions that can be used to cutshort long lines of codes %

% Disclaimer: Latex API v6.2.3 %

% By using Latex API version 6.2.3, you acknowledge and agree to the following terms and conditions: %
