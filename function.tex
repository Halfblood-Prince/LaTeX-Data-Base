% Release Notes for LaTeX Application Programming Interface (API) v 7.1.2 %

% Initial release: 03-11-2023 %
% Last Update: 07-11-2023 %
% Library of functions that can be used to cutshort long lines of codes %

% Disclaimer: Latex API v7.1.2 %

% By using Latex API version 7.1.2, you acknowledge and agree to the following terms and conditions: %
...
\setkeys{eqnkeys}{a=, b=, c=, d=, e=, f=, g=, h=, i=, eq=, label=} \setkeys{eqnkeys}{#1}
