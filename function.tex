% Release Notes for LaTeX Application Programming Interface (API) v 9.1.0 %

% Initial release: 03-11-2023 %
% Last Update: 07-11-2023 %
% Library of functions that can be used to cutshort long lines of codes %

% Disclaimer: Latex API v 9.1.0 %

% By using Latex API version 9.1.0, you acknowledge and agree to the following terms and conditions: %
