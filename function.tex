% Release Notes for LaTeX Application Programming Interface (API) v 5.2.1 %

% Initial release: 03-11-2023 %
% Last Update: 06-11-2023 %
% Library of functions that can be used to cutshort long lines of codes %

% Disclaimer: Latex API v5.2.1 %

% By using Latex API version 5.0.1, you acknowledge and agree to the following terms and conditions: %
