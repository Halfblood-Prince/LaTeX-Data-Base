% Release Notes for LaTeX Application Programming Interface (API) v 6.0.0 %

% Initial release: 03-11-2023 %
% Last Update: 06-11-2023 %
% Library of functions that can be used to cutshort long lines of codes %

% Disclaimer: Latex API v6.0.0 %

% By using Latex API version 6.0.0, you acknowledge and agree to the following terms and conditions: %
...
\makeatletter \define@key{imgkeys}{name}{\def\imgname{#1}} \define@key{imgkeys}{width}{\def\imgwidth{#1}} \define@key{imgkeys}{caption}{\def\imgcaption{#1}} \define@key{imgkeys}{label}{\def\imglabel{#1}} \define@key{rowkeys}{lname}{\def\leftimgname{#1}} \define@key{rowkeys}{lcaption}{\def\leftimgcaption{#1}} \define@key{rowkeys}{llabel} {\def\leftimglabel{#1}} \define@key{rowkeys}{rname}{\def\rightimgname{#1}} \define@key{rowkeys}{rcaption}{\def\rightimgcaption{#1}} \define@key{rowkeys}{rlabel} {\def\rightimglabel{#1}} \define@key{rowkeys}{imgcaption}{\def\fullimgcaption{#1}} \define@key{rowkeys}{imglabel}{\def\fullimglabel{#1}} \define@key{tblkeys}{tableone}{\def\tblone{#1}} \define@key{tblkeys}{tabletwo}{\def\tbltwo{#1}} \define@key{tblkeys}{caption}{\def\tblcap{#1}} \define@key{tblkeys}{label}{\def\tbllab{#1}} \define@key{mykeys}{param1}[]{\def\myparamone{#1}} \define@key{mykeys}{param2}[]{\def\myparamtwo{#1}} \define@key{mykeys}{param3}[]{\def\myparamthree{#1}} \define@key{mykeys}{param4}[]{\def\myparamfour{#1}} \define@key{mykeys}{param5}[]{\def\myparamfive{#1}} \define@key{mykeys}{param6}[]{\def\myparamsix{#1}} \define@key{mykeys}{param7}[]{\def\myparamseven{#1}} \define@key{mykeys}{param8}[]{\def\myparameight{#1}} \define@key{mykeys}{param9}[]{\def\myparamnine{#1}} \newcommand{\eqdef}[1]{%
\setkeys{mykeys}{param1=, param2=, param3=, param4=, param5=, param6=, param7=, param8=, param9=} \setkeys{mykeys}{#1} where: \begin{itemize}   \ifx\myparamone\empty\else \item \myparamone \fi   \ifx\myparamtwo\empty\else \item \myparamtwo \fi   \ifx\myparamthree\empty\else \item \myparamthree \fi   \ifx\myparamfour\empty\else \item \myparamfour \fi \ifx\myparamfive\empty\else \item \myparamfive \fi \ifx\myparamsix\empty\else \item \myparamsix \fi \ifx\myparamseven\empty\else \item \myparamseven \fi \ifx\myparameight\empty\else \item \myparameight \fi \ifx\myparamnine\empty\else \item \myparamnine \fi \end{itemize} \setkeys{mykeys}{param1=, param2=, param3=, param4=, param5=, param6=, param7=, param8=, param9=} } \newcommand{\img}[1]{%
\setkeys{imgkeys}{#1} %
