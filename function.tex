...
\define@key{mykeys}{a}[]{\def\myparamone{#1}}
\define@key{mykeys}{b}[]{\def\myparamtwo{#1}}
\define@key{mykeys}{c}[]{\def\myparamthree{#1}}
\define@key{mykeys}{d}[]{\def\myparamfour{#1}}
\define@key{mykeys}{e}[]{\def\myparamfive{#1}}
\define@key{mykeys}{f}[]{\def\myparamsix{#1}}
\define@key{mykeys}{g}[]{\def\myparamseven{#1}}
\define@key{mykeys}{h}[]{\def\myparameight{#1}}
\define@key{mykeys}{i}[]{\def\myparamnine{#1}} 
